    ...
    const documentDefinition = {
      ...
      content: [
        ...
        sale.paymentMethod === 'INVOICE' ? {
          columns: [
            ...
            [
              ...
              {text: `CUSTOMER:  `, style: 'textRegular', alignment: 'right'},
              {text: `TEL NO: `, style: 'textRegular', alignment: 'right'}
            ]
          ]
        } : {
          columns: [
        ...
        sale.paymentMethod === 'INVOICE' != true ? {
          columns: [
            [
              {text: `CASH SALE #${sale.receiptNumber}`, style: 'textRegular', alignment: 'left'},
              {text: `DATE TIME: ${new Date(Date.now()).toLocaleDateString()}`, style: 'textRegular', alignment: 'left'},
              {text: `SHOP NAME: ${this.shop.name.toUpperCase()}`, style: 'textRegular', alignment: 'left'}
            ]
          ]
        } : {
        ...
        {
          table: {
            headerRows: sale.paymentMethod === 'INVOICE' ? 1 : 0,
        ...
        },
        {
          columns: [
            {
              text: sale.paymentMethod === 'INVOICE' ? '' : 'CASH PAID: ',
              style: 'textRegularLarge',
              margin: [0, 0, 0, 35],
              bold: true,
              colspan: 6
        ...
        sale.paymentMethod === 'INVOICE' ? {} : {
          columns: [
            ...
            }, {}, {text: ``, style: 'textRegularLarge', bold: true}
          ]
        },
        sale.paymentMethod === 'INVOICE' != true ? {
