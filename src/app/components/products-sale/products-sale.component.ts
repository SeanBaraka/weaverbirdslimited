  ...
  printReceipt(amount?: any): void {
    const documentDefinition = {
      ...
      content: [
        ...
        this.paymentMethod.invoice ? {
          columns: [
            [
              ...
              {text: 'P.O. Box 6408-00200 NAIROBI KENYA', style: 'textRegular', alignment: this.paymentMethod.invoice ? 'left' : 'center'}
            ],
          ...
          columns: [
            [
              ...
              {text: `${this.data.shopName}`, style: 'textRegular', alignment: this.paymentMethod.invoice ? 'left' : 'center'},
              {text: 'TELEPHONE: 0712694934 . 0722794988', style: 'textRegular', alignment: this.paymentMethod.invoice ? 'left' : 'center'},
              {text: 'Email Address: info@pourtaplimited.co.ke', style: 'textRegular', alignment: this.paymentMethod.invoice ? 'left' : 'center'},
        ...
        this.paymentMethod.invoice !== true ? {
          columns: [
            [
              ...
              {text: `Receipt Number #${this.receiptNumber} | Till Number: 5060027`, style: 'subHeading', bold: true, alignment: 'center' },
        ...
        {
          text: this.paymentMethod.invoice ? 'INVOICE SALE' : '' ? this.paymentMethod.quotation : 'Quotation',
          bold: true,
          style: 'subHeading',
          alignment: this.paymentMethod.invoice ? 'left' : 'center'
        },
        ...
        },
        {
          columns: [
            {
              text: this.paymentMethod.mobile ? 'Amount paid' : this.paymentMethod.invoice ? '' : 'CASH PAID: ',
              style: 'textRegularLarge',
              margin: [0, 0, 0, 35],
              bold: true,
              colspan: 6
        ...
        {
          text: `You Were Served By: ${this.user.name}`,
          bold: true,
          style: 'textRegular',
          margin: [0, 35, 0, 35]
        }
